...
write "; Skipping Step 1.3 since MM is contained in th startup script "
write ";**********************************************************************"
...
write "; Skipping Step 1.4 since TST_MM is contained in th startup script "
write ";**********************************************************************"
...
validAddr = SCX_CPU1_TST_MM_EEPROMADDRESS + 1
LOCAL textValueRead
...
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=8 EEPROM SymName="" Offset=validAddr
...
;;	Will have to parse the event msg that gets returned
  ...
  write "; DataValue value = ", %hex(SCX_CPU1_MM_DataValue,2)
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_PEEK) AND ;;
     (SCX_CPU1_MM_MemType = MM_EEPROM) AND ;;
  ...
  write "<!> Failed (1009;3001) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_PEEK_BYTE_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_3001, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent EEPROM DataSize=3 SymName="" Offset=validAddr-1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;3002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_DUMP_INEVENT_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_3002, "F"
endif
...
write ";**********************************************************************"
ut_setupevents "SCX","CPU1",{MMAppName},MM_EEPROM_WRITE_ENA_INF_EID,"INFO",1

cmdCtr = SCX_CPU1_MM_CMDPC + 1

/SCX_CPU1_MM_EnableEEWrite Bank=0
...
if (UT_TW_Status = UT_Success) then
  ...
  ut_setrequirements MM_1009, "P"
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_EEPROMWRITE_ENA) AND ;;
     (SCX_CPU1_MM_MemType = MM_EEPROM) AND ;;
     (SCX_CPU1_MM_Address = 0) AND (SCX_CPU1_MM_DataValue = 0) AND ;;
     (SCX_CPU1_MM_BytesProc = 0) AND (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_EEPROM_WRITE_ENA_INF_EID,"."
  ut_setrequirements MM_1009, "F"
endif
...
/SCX_CPU1_MM_Poke DataSize=8 EEPROM Data=pokeValue SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;3000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_POKE_BYTE_INF_EID,"."
  ut_setrequirements MM_1009, "F"
...
write ";**********************************************************************"
ut_setupevents "SCX","CPU1",{MMAppName},MM_EEPROM_WRITE_DIS_INF_EID,"INFO",1

cmdCtr = SCX_CPU1_MM_CMDPC + 1

/SCX_CPU1_MM_DisableEEWrite Bank=0
...
if (UT_TW_Status = UT_Success) then
  ...
  ut_setrequirements MM_1009, "P"
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_EEPROMWRITE_DIS) AND ;;
     (SCX_CPU1_MM_MemType = MM_EEPROM) AND ;;
     (SCX_CPU1_MM_Address = 0) AND (SCX_CPU1_MM_DataValue = 0) AND ;;
     (SCX_CPU1_MM_BytesProc = 0) AND (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_EEPROM_WRITE_DIS_INF_EID,"."
  ut_setrequirements MM_1009, "F"
endif
...
validAddr = SCX_CPU1_TST_MM_EEPROMADDRESS + 2
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=16 EEPROM SymName="" Offset=validAddr
...
;;	Will have to parse the event msg that gets returned
  write "==== Event Text = '", SCX_CPU1_find_event[1].event_txt, "'"
  textValueRead = %substring(SCX_CPU1_find_event[1].event_txt,57,60)
  write "; Parsed text value = '", textValueRead
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_PEEK) AND ;;
     (SCX_CPU1_MM_MemType = MM_EEPROM) AND ;;
  ...
  write "<!> Failed (1009;3001) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_PEEK_WORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_3001, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent EEPROM DataSize=6 SymName="" Offset=validAddr-2
...
/SCX_CPU1_MM_Poke DataSize=16 EEPROM Data=pokeValue SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;3000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_POKE_WORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_30001, "F"
endif
...
write ";**********************************************************************"
;; Determine a valid EEPROM address
validAddr = SCX_CPU1_TST_MM_EEPROMAddress + 4
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=32 EEPROM SymName="" Offset=validAddr
...
;;	Will have to parse the event msg that gets returned
  write "==== Event Text = '", SCX_CPU1_find_event[1].event_txt, "'"
  textValueRead = %substring(SCX_CPU1_find_event[1].event_txt,57,64)
  write "; Parsed text value = '", textValueRead
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_PEEK) AND ;;
     (SCX_CPU1_MM_MemType = MM_EEPROM) AND ;;
  ...
  write "<!> Failed (1009;3001) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_PEEK_DWORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_3001, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent EEPROM DataSize=12 SymName="" Offset=validAddr-4
...
/SCX_CPU1_MM_Poke DataSize=32 EEPROM Data=pokeValue SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;3000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_POKE_DWORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_30001, "F"
endif
...
invalidAddr = SCX_CPU1_TST_MM_RAMAddress+4

/SCX_CPU1_MM_Poke DataSize=32 EEPROM Data=pokeValue SymName="" Offset=invalidAddr
...
LOCAL errCtr = SCX_CPU1_MM_CMDEC + 1
...
/SCX_CPU1_MM_Poke DataSize=4 EEPROM Data=pokeValue SymName="" Offset=validAddr
...
/SCX_CPU1_MM_Peek DataSize=32 EEPROM SymName="" Offset=invalidAddr
...
/SCX_CPU1_MM_Peek DataSize=3 EEPROM SymName="" Offset=validAddr
...
validAddr = SCX_CPU1_TST_MM_EEPROMAddress
dataToSend = 1024

;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=validAddr Pattern=x'AF' EEPROM SymbolName="" Filename="/ram/valideeload.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/valideeload.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_LOAD_FROM_FILE) AND ;;
     ...
     (SCX_CPU1_MM_LastFile = "/ram/valideeload.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_DUMP_TO_FILE) AND ;;
     ...
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = dataToSend) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/mm_ee3_2_dump.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent EEPROM DataSize=eventBytes SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent EEPROM DataSize=MM_MAX_DUMP_INEVENT_BYTES SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent EEPROM DataSize=1 SymName="" Offset=validAddr
...
/SCX_CPU1_MM_DumpInEvent EEPROM DataSize=10 SymName="" Offset=invalidAddr
...
/SCX_CPU1_MM_DumpInEvent EEPROM DataSize=0 SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateErrorFiles Address=validAddr Pattern=x'FA' EEPROM
wait 5
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=MM_MAX_LOAD_FILE_DATA_EEPROM Address=validAddr Pattern=x'AF' EEPROM SymbolName="" Filename="/ram/maxdataeeload.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/maxdataeeload.dat"
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=1 Address=validAddr Pattern=x'55' EEPROM SymbolName="" Filename="/ram/onebyteeeload.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/onebyteeeload.dat"
...
/SCX_CPU1_TST_MM_CreateFile DataSize=2048 Address=invalidAddr Pattern=x'A5' EEPROM SymbolName="" Filename="/ram/badeeaddrload.dat"
wait 5
...
/SCX_CPU1_MM_LoadFile Filename="/ram/badeeaddrload.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File EEPROM DataSize=MM_MAX_DUMP_FILE_DATA_EEPROM+1 SymName="" Offset=validAddr Filename="/ram/mm_ee4_13_dump.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File EEPROM DataSize=dataToSend SymName="" Offset=invalidAddr Filename="/ram/mm_ee4_17_dump.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File EEPROM DataSize=dataToSend SymName="" Offset=validAddr Filename="mm_invalid_dumpname.dat"
...
;; CPU1 is the default
rawcmd = ""
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File EEPROM DataSize=0 SymName="" Offset=validAddr Filename="/ram/mm_dump_14_19_2.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File EEPROM DataSize=100 SymName="" Offset=validAddr Filename=""
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill EEPROM DataSize=MM_MAX_DUMP_INEVENT_BYTES Pattern=x'FFFFFFFF' SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;2004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_DUMP_INEVENT_INF_EID,"."
  ut_setrequirements MM_1009, "F"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill EEPROM DataSize=MM_MAX_FILL_DATA_EEPROM+1 Pattern=x'AAAAAAAA' SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill EEPROM DataSize=MM_MAX_FILL_DATA_EEPROM Pattern=x'55555555' SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_FILL) AND ;;
     ...
     (SCX_CPU1_MM_BytesProc = MM_MAX_FILL_DATA_EEPROM) AND ;;
     (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_DUMP_TO_FILE) AND ;;
     ...
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = MM_MAX_FILL_DATA_EEPROM) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/mm_ee5_5_dump.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill EEPROM DataSize=1 Pattern=x'BBBBBBBB' SymName="" Offset=validAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill EEPROM DataSize=10 Pattern=x'FFFFFFFF' SymName="" Offset=invalidAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill EEPROM DataSize=0 Pattern=x'FAFAFAFA' SymName="" Offset=validAddr
...
write ";**********************************************************************"
;; Send the ES command 
/SCX_CPU1_ES_STARTPERF TriggerStart
...
/SCX_CPU1_ES_StopPerf DataFileName="/ram/mm_eeprom_perf.dat"
wait 30
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_mm_eeprom                                   "
write ";*********************************************************************"
ENDPROC
