...
;
;  Test Description
;	This test verifies that the CFS Memory Manager (MM) Memory Mapped I/O
...
;       09/03/20        Walt Moleski    Updated for MM 2.4.2.0.
;
;  Arguments
;	None.
;
...
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_INIT_INF_EID, "INFO", 2
...
/SCX_CPU1_TO_ADDPACKET Stream=stream1 Pkt_Size=x'0' Priority=x'0' Reliability=x'1' Buflimit=x'4'
wait 10
...
write ";**********************************************************************"
ut_setupevents "SCX", "CPU1", "CFE_ES", CFE_ES_START_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", "TST_MM", TST_MM_INIT_INF_EID, "INFO", 2
...
if (SCX_CPU1_MM_CMDPC = 0) AND (SCX_CPU1_MM_CMDEC = 0) AND ;;
   (SCX_CPU1_MM_LastActn = 0) AND (SCX_CPU1_MM_MemType = 0) AND ;;
   (SCX_CPU1_MM_Address = 0) AND (SCX_CPU1_MM_DataValue = 0) AND ;;
   (SCX_CPU1_MM_BytesProc = 0) AND (SCX_CPU1_MM_LastFile = "") THEN
  ...
  write "  CMDPC           = ",SCX_CPU1_MM_CMDPC
  write "  CMDEC           = ",SCX_CPU1_MM_CMDEC
  write "  Last Action     = ",SCX_CPU1_MM_LastActn
  write "  MemType         = ",SCX_CPU1_MM_MemType
  write "  Address         = ",SCX_CPU1_MM_Address
  write "  Data Value      = ",SCX_CPU1_MM_DataValue
  write "  Bytes processed = ",SCX_CPU1_MM_BytesProc
  write "  Filename        = ",SCX_CPU1_MM_LastFile
...
;; Get a valid address
validAddr = SCX_CPU1_TST_MM_RAMAddress + 1

;; Setup for the Peek Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_PEEK_BYTE_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=8 MEM8 SymName="" Offset=validAddr

ut_tlmwait  SCX_CPU1_MM_CMDPC, {cmdCtr}
if (UT_TW_Status = UT_Success) then
...
;;	Will have to parse the event msg that gets returned
  write "==== Event Text = '", SCX_CPU1_find_event[1].event_txt, "'"
  textValueRead = %substring(SCX_CPU1_find_event[1].event_txt,56,57)
  write "; Parsed text value = '", textValueRead,"'"
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_PEEK) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM8) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = 1) AND (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
    write "  Last Action     = ",p@SCX_CPU1_MM_LastActn
    write "  MemType         = ",p@SCX_CPU1_MM_MemType
    write "  Address         = ",%hex(SCX_CPU1_MM_Address,8)
    write "  Data Value      = ",%hex(SCX_CPU1_MM_DataValue,2)
    write "  Bytes processed = ",SCX_CPU1_MM_BytesProc
    write "  Filename        = ",SCX_CPU1_MM_LastFile
    ut_setrequirements MM_8000, "F"
  endif
else
  write "<!> Failed (1009;5002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_PEEK_BYTE_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_5002, "F"
endif
...
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_DUMP_INEVENT_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent MEM8 DataSize=3 SymName="" Offset=validAddr-1
...
if (UT_TW_Status = UT_Success) then
  ...
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_DUMP_INEVENT) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM8) AND ;;
     (SCX_CPU1_MM_Address = validAddr-1) AND ;;
     (SCX_CPU1_MM_BytesProc = 3) AND (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
  ...
  write "<!> Failed (1009;5002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_DUMP_INEVENT_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_5002, "F"
endif
...
write ";**********************************************************************"
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_POKE_BYTE_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1

/SCX_CPU1_MM_Poke DataSize=8 MEM8 Data=pokeValue SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_POKE) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM8) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_DataValue = pokeValue) AND ;;
     (SCX_CPU1_MM_BytesProc = 1) AND (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
  ...
  write "<!> Failed (1009;5000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_POKE_BYTE_INF_EID,"."
  ut_setrequirements MM_1009, "F"
...
write ";**********************************************************************"
;; Get a valid address
validAddr = SCX_CPU1_TST_MM_RAMAddress + 2

;; Setup for the Peek Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_PEEK_WORD_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=16 MEM16 SymName="" Offset=validAddr
...
;;	Will have to parse the event msg that gets returned
  write "==== Event Text = '", SCX_CPU1_find_event[1].event_txt, "'"
  textValueRead = %substring(SCX_CPU1_find_event[1].event_txt,56,60)
  write "; Parsed text value = '", textValueRead
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_PEEK) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM16) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = 2) AND (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
  ...
  write "<!> Failed (1009;5002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_PEEK_WORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_5002, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent MEM16 DataSize=6 SymName="" Offset=validAddr-2
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_DUMP_INEVENT) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM16) AND ;;
     (SCX_CPU1_MM_Address = validAddr-2) AND ;;
     (SCX_CPU1_MM_BytesProc = 6) AND (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
write ";**********************************************************************"
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_POKE_WORD_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1

/SCX_CPU1_MM_Poke DataSize=16 MEM16 Data=pokeValue SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;5000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_POKE_WORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_50001, "F"
endif
...
validAddr = SCX_CPU1_TST_MM_RAMAddress + 4

;; Setup for the Peek Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_PEEK_DWORD_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=32 MEM32 SymName="" Offset=validAddr
...
;;	Will have to parse the event msg that gets returned
  write "==== Event Text = '", SCX_CPU1_find_event[1].event_txt, "'"
  textValueRead = %substring(SCX_CPU1_find_event[1].event_txt,56,64)
  write "; Parsed text value = '", textValueRead
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_PEEK) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM32) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = 4) AND (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
  ...
  write "<!> Failed (1009;5002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_PEEK_DWORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_5002, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent MEM32 DataSize=12 SymName="" Offset=validAddr-4
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_DUMP_INEVENT) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM32) AND ;;
     (SCX_CPU1_MM_Address = validAddr-4) AND ;;
     (SCX_CPU1_MM_BytesProc = 12) AND (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
write ";**********************************************************************"
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_POKE_DWORD_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1

/SCX_CPU1_MM_Poke DataSize=32 MEM32 Data=pokeValue SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;5000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_POKE_DWORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_50001, "F"
endif
...
write ";**********************************************************************"
;; Setup for the event
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_OS_MEMVALIDATE_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
invalidAddr = 12

/SCX_CPU1_MM_Poke DataSize=32 MEM32 Data=pokeValue SymName="" Offset=invalidAddr

ut_tlmwait  SCX_CPU1_MM_CMDEC, {errCtr}
if (UT_TW_Status = UT_Success) then
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_OS_MEMVALIDATE_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
write ";**********************************************************************"
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_LEN_ERR_EID, "ERROR", 1
...
ut_sendrawcmd "SCX_CPU1_MM", (rawcmd)
...
if (SCX_CPU1_num_found_messages = 1) THEN
  write "<*> Passed (1010) - Event message ",SCX_CPU1_find_event[1].eventid, " received"
  ut_setrequirements MM_1010, "P"
else
  write "<!> Failed (1010) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",MM_LEN_ERR_EID, "."
  ut_setrequirements MM_1010, "F"
endif
...
write ";**********************************************************************"
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_MEMTYPE_ERR_EID, "ERROR", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_MEMTYPE_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
write ";**********************************************************************"
;; Setup for the event
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_DATA_SIZE_BITS_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1

/SCX_CPU1_MM_Poke DataSize=4 MEM8 Data=pokeValue SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_DATA_SIZE_BITS_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
/SCX_CPU1_MM_Peek DataSize=32 MEM32 SymName="" Offset=invalidAddr
...
/SCX_CPU1_MM_Peek DataSize=3 MEM16 SymName="" Offset=validAddr
...
ut_setupevents "SCX", "CPU1", "TST_MM", TST_MM_CREATEFILE_INF_EID, "INFO", 1

validAddr = SCX_CPU1_TST_MM_RAMAddress + 1
LOCAL dataToSend = 1024

;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=validAddr Pattern=x'AF' MEM8 SymbolName="" Filename="/ram/validmm8load.dat"
wait 5

ut_tlmwait  SCX_CPU1_TST_MM_CMDPC, {cmdCtr}
if (UT_TW_Status <> UT_Success) then
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",TST_MM_CREATEFILE_INF_EID,"."
endif

;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_LD_MEM_FILE_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/validmm8load.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  ut_setrequirements MM_1009, "P"
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_LOAD_FROM_FILE) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM8) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;; 
     (SCX_CPU1_MM_BytesProc = dataToSend) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/validmm8load.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_LD_MEM_FILE_INF_EID,"."
  ut_setrequirements MM_1009, "F"
endif
...
write ";**********************************************************************"
;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_DMP_MEM_FILE_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm_mm8_32_dump.dat",hostCPU,appPktID,"MEM8",dataToSend,"",validAddr)
...
if (UT_TW_Status = UT_Success) then
  ...
  ut_setrequirements MM_1009, "P"
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_DUMP_TO_FILE) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM8) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = dataToSend) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/mm_mm8_32_dump.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_DMP_MEM_FILE_INF_EID,"."
  ut_setrequirements MM_1009, "F"
endif

;; Delete the onboard file
s ftp_file (ramDir,"na","mm_mm8_32_dump.dat",hostCPU,"R")
...
write ";**********************************************************************"
;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_DATA_SIZE_BYTES_ERR_EID, "ERROR", 1

local eventBytes = MM_MAX_DUMP_INEVENT_BYTES+1 

errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent MEM32 DataSize=eventBytes SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_DATA_SIZE_BYTES_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
write ";  maximum event message size that is MEM16 aligned. "
write ";**********************************************************************"
;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_DUMP_INEVENT_INF_EID, "INFO", 1

validAddr = SCX_CPU1_TST_MM_RAMAddress

cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
;; Prior to 2.4.1.0, MM_MAX_DUMP_INEVENT_BYTES was MEM16 aligned
;;/SCX_CPU1_MM_DumpInEvent MEM16 DataSize=MM_MAX_DUMP_INEVENT_BYTES SymName="" Offset=validAddr
/SCX_CPU1_MM_DumpInEvent MEM16 DataSize=14 SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent MEM8 DataSize=1 SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;5004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_DUMP_INEVENT_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_5004, "F"
endif
...
/SCX_CPU1_MM_DumpInEvent MEM32 DataSize=10 SymName="" Offset=invalidAddr
...
/SCX_CPU1_MM_DumpInEvent MEM16 DataSize=0 SymName="" Offset=validAddr
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=validAddr Pattern=x'AF' MEM16 SymbolName="" Filename="/ram/validmm16load.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/validmm16load.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_LOAD_FROM_FILE) AND ;;
     ...
     (SCX_CPU1_MM_Address = validAddr) AND ;; 
     (SCX_CPU1_MM_BytesProc = dataToSend) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/validmm16load.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm_mm16_42_dump.dat",hostCPU,appPktID,"MEM16",dataToSend,"",validAddr)
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_DUMP_TO_FILE) AND ;;
     ...
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = dataToSend) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/mm_mm16_42_dump.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
;; Delete the onboard file
s ftp_file (ramDir,"na","mm_mm16_42_dump.dat",hostCPU,"R")
...
s create_mm_file_from_cvt(hostCPU,varPktID,appPktID,hexAppID,"MEM16 Load File with an invalid CRC","badmem16crcload.dat")

;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_LOAD_FILE_CRC_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
;; Transfer the file to s/c and issue the MM LoadFile command
s load_memory ("badmem16crcload.dat", hostCPU)
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_LOAD_FILE_CRC_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif

;; Delete the onboard file
s ftp_file (ramDir,"na","badmem16crcload.dat",hostCPU,"R")
...
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateErrorFiles Address=validAddr Pattern=x'FA' MEM16
wait 5
...
errCtr = SCX_CPU1_MM_CMDEC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/overmaxload.dat"
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=MM_MAX_LOAD_FILE_DATA_MEM16 Address=validAddr Pattern=x'AF' MEM16 SymbolName="" Filename="/ram/maxdatamm16load.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/maxdatamm16load.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_LOAD_FROM_FILE) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM16) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;; 
     (SCX_CPU1_MM_BytesProc = MM_MAX_LOAD_FILE_DATA_MEM16) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/maxdatamm16load.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
s ftp_file (ramDir,"maxdatamm16load.dat","maxdatamm16load.dat",hostCPU,"G")

;; Delete the onboard file
s ftp_file (ramDir,"na","maxdatamm16load.dat",hostCPU,"R")
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=1 Address=validAddr Pattern=x'55' MEM16 SymbolName="" Filename="/ram/onebytemm16load.dat"
wait 5
...
;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_ALIGN16_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/onebytemm16load.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_ALIGN16_ERR_EID,"."
  ut_setrequirements MM_1009, "F"
endif
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=2 Address=validAddr Pattern=x'AA' MEM16 SymbolName="" Filename="/ram/twobytemm16load.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/twobytemm16load.dat"
...
write ";**********************************************************************"
;; Create the Load File
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=invalidAddr Pattern=x'AF' MEM8 SymbolName="" Filename="/ram/badmm16addrload.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Transfer the file to s/c and issue the MM LoadFile command
s load_memory ("badmm16addrload.dat", hostCPU)
...
write ";**********************************************************************"
;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_LD_FILE_SIZE_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/toomuchdata.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_LD_FILE_SIZE_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
errCtr = SCX_CPU1_MM_CMDEC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/notenoughdata.dat"
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm_mm8_411_dump.dat",hostCPU,appPktID,"MEM8",dataToSend,"",validAddr)
...
;; Delete the onboard file
s ftp_file (ramDir,"na","mm_mm8_411_dump.dat",hostCPU,"R")
...
;; Create the Load File
s create_mm_file_from_cvt(hostCPU,varPktID,appPktID,hexAppID,"MEM8 Load File with an invalid CRC","badmem8crcload.dat")
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Transfer the file to s/c and issue the MM LoadFile command
s load_memory ("badmem8crcload.dat", hostCPU)
...
;; Delete the onboard file
s ftp_file (ramDir,"na","badmem8crcload.dat",hostCPU,"R")
...
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateErrorFiles Address=validAddr Pattern=x'FA' MEM8
wait 5
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=MM_MAX_LOAD_FILE_DATA_MEM8 Address=validAddr Pattern=x'AF' MEM8 SymbolName="" Filename="/ram/maxdatamm8load.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/maxdatamm8load.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_LOAD_FROM_FILE) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM8) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;; 
     (SCX_CPU1_MM_BytesProc = MM_MAX_LOAD_FILE_DATA_MEM8) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/maxdatamm8load.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
s ftp_file (ramDir,"maxdatamm8load.dat","maxdatamm8load.dat",hostCPU,"G")

;; Delete the onboard file
s ftp_file (ramDir,"na","maxdatamm8load.dat",hostCPU,"R")
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=1 Address=validAddr Pattern=x'55' MEM8 SymbolName="" Filename="/ram/onebytemm8load.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/onebytemm8load.dat"
...
write ";**********************************************************************"
;; Create the Load File
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=invalidAddr Pattern=x'AF' MEM8 SymbolName="" Filename="/ram/badmm8addrload.dat"

;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_OS_MEMVALIDATE_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/badmm8addrload.dat"
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=validAddr Pattern=x'AF' MEM32 SymbolName="" Filename="/ram/validmm32load.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/validmm32load.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_LOAD_FROM_FILE) AND ;;
     ...
     (SCX_CPU1_MM_Address = validAddr) AND ;; 
     (SCX_CPU1_MM_BytesProc = dataToSend) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/validmm32load.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm_m32_420_dump.dat",hostCPU,appPktID,"MEM32",dataToSend,"",validAddr)
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_DUMP_TO_FILE) AND ;;
     ...
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = dataToSend) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/mm_m32_420_dump.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
;; Delete the onboard file
s ftp_file (ramDir,"na","mm_m32_420_dump.dat",hostCPU,"R")
...
;; Create the Load File
s create_mm_file_from_cvt(hostCPU,varPktID,appPktID,hexAppID,"MEM32 Load File with an invalid CRC","badmem32crcload.dat")
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Transfer the file to s/c and issue the MM LoadFile command
s load_memory ("badmem32crcload.dat", hostCPU)
...
;; Delete the onboard file
s ftp_file (ramDir,"na","badmem32crcload.dat",hostCPU,"R")
...
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateErrorFiles Address=validAddr Pattern=x'FA' MEM32
wait 5
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=MM_MAX_LOAD_FILE_DATA_MEM32 Address=validAddr Pattern=x'AF' MEM32 SymbolName="" Filename="/ram/maxdatamm32load.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/maxdatamm32load.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_LOAD_FROM_FILE) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM32) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;; 
     (SCX_CPU1_MM_BytesProc = MM_MAX_LOAD_FILE_DATA_MEM32) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/maxdatamm32load.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
write ";**********************************************************************";
; Get the onboard file
s ftp_file (ramDir,"maxdatamm32load.dat","maxdatamm32load.dat",hostCPU,"G")

;; Delete the onboard file
s ftp_file (ramDir,"na","maxdatamm32load.dat",hostCPU,"R")
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=1 Address=validAddr Pattern=x'55' MEM32 SymbolName="" Filename="/ram/onebytemm32load.dat"
wait 5
...
;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_ALIGN32_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/onebytemm32load.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_ALIGN32_ERR_EID,"."
  ut_setrequirements MM_1009, "F"
endif
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=4 Address=validAddr Pattern=x'BA' MEM32 SymbolName="" Filename="/ram/minmem32load.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/minmem32load.dat"
...
write ";**********************************************************************"
;; Create the Load File
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=invalidAddr Pattern=x'AF' MEM32 SymbolName="" Filename="/ram/badmm32addrload.dat"

;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_OS_MEMVALIDATE_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/badmm32addrload.dat"
...
write ";**********************************************************************"
;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_OS_OPEN_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_LoadFile Filename="/ram/mmFileMissing.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_OS_OPEN_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
write ";**********************************************************************"
;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_CMD_FNAME_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_LoadFile Filename=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_CMD_FNAME_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_LoadFile Filename="/ram/ab(3)"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File MEM16 DataSize=MM_MAX_DUMP_FILE_DATA_MEM16+1 SymName="" Offset=validAddr Filename="/ram/mm_m16_431_dump.dat"
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm_m16_432_dump.dat",hostCPU,appPktID,"MEM16",MM_MAX_DUMP_FILE_DATA_MEM16,"",validAddr)
...
;; Delete the onboard file
s ftp_file (ramDir,"na","mm_m16_432_dump.dat",hostCPU,"R")
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm16_4331_dump.dat",hostCPU,appPktID,"MEM16",1,"",validAddr)
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm16_4332_dump.dat",hostCPU,appPktID,"MEM16",2,"",validAddr)
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File MEM16 DataSize=dataToSend SymName="" Offset=invalidAddr Filename="/ram/mm_m16_434_dump.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File MEM8 DataSize=MM_MAX_DUMP_FILE_DATA_MEM8+1 SymName="" Offset=validAddr Filename="/ram/mm_m8_435_dump.dat"
...
;; Delete the onboard file
s ftp_file (ramDir,"na","mm_m8_435_dump.dat",hostCPU,"R")
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm_m8_436_dump.dat",hostCPU,appPktID,"MEM8",MM_MAX_DUMP_FILE_DATA_MEM8,"",validAddr)
...
;; Delete the onboard file
s ftp_file (ramDir,"na","mm_m8_436_dump.dat",hostCPU,"R")
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm_m8_437_dump.dat",hostCPU,appPktID,"MEM8",1,"",validAddr)
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File MEM8 DataSize=dataToSend SymName="" Offset=invalidAddr Filename="/ram/mm_m8_438_dump.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File MEM32 DataSize=MM_MAX_DUMP_FILE_DATA_MEM32+1 SymName="" Offset=validAddr Filename="/ram/mm_m32_439_dump.dat"
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm_m32_440_dump.dat",hostCPU,appPktID,"MEM32",MM_MAX_DUMP_FILE_DATA_MEM32,"",validAddr)
...
;; Delete the onboard file
s ftp_file (ramDir,"na","mm_m32_440_dump.dat",hostCPU,"R")
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm32_4411_dump.dat",hostCPU,appPktID,"MEM32",1,"",validAddr)
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm32_4412_dump.dat",hostCPU,appPktID,"MEM32",4,"",validAddr)
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File MEM32 DataSize=dataToSend SymName="" Offset=invalidAddr Filename="/ram/mm_m32_442_dump.dat"
...
write ";**********************************************************************"
;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_OS_CREAT_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File MEM16 DataSize=dataToSend SymName="" Offset=validAddr Filename="mm_bad_dumpname.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_OS_CREAT_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File MEM32 DataSize=0 SymName="" Offset=validAddr Filename="/ram/mm_dump_4_452.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File MEM8 DataSize=100 SymName="" Offset=validAddr Filename=""
...
write ";**********************************************************************"
;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_FILL_INF_EID, "INFO", 1

validAddr = SCX_CPU1_TST_MM_RAMAddress

cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM8 DataSize=MM_MAX_DUMP_INEVENT_BYTES Pattern=x'FFFFFFFF' SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  ut_setrequirements MM_1009, "P"
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_FILL) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM8) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_DataValue = x'FF') AND ;;
     (SCX_CPU1_MM_BytesProc = MM_MAX_DUMP_INEVENT_BYTES) AND ;;
     (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_FILL_INF_EID,"."
  ut_setrequirements MM_1009, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent MEM8 DataSize=MM_MAX_DUMP_INEVENT_BYTES SymName="" Offset=validAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM8 DataSize=MM_MAX_FILL_DATA_MEM8+1 Pattern=x'AAAAAAAA' SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_DATA_SIZE_BYTES_ERR_EID,"."
  ut_setrequirements MM_1009, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM8 DataSize=MM_MAX_FILL_DATA_MEM8 Pattern=x'55555555' SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_FILL) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM8) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_DataValue = x'55') AND ;;
     (SCX_CPU1_MM_BytesProc = MM_MAX_FILL_DATA_MEM8) AND ;;
     (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm8_55_dump.dat",hostCPU,appPktID,"MEM8",MM_MAX_FILL_DATA_MEM8,"",validAddr)
...
;; Delete the onboard file
s ftp_file (ramDir,"na","mm8_55_dump.dat",hostCPU,"R")
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM8 DataSize=1 Pattern=x'BBBBBBBB' SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent MEM8 DataSize=3 SymName="" Offset=validAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM8 DataSize=10 Pattern=x'FFFFFFFF' SymName="" Offset=invalidAddr
...
;; Send the command
;; Prior to 2.4.1.0, MM_MAX_DUMP_INEVENT_BYTES was MEM16 aligned
;;/SCX_CPU1_MM_Fill MEM16 DataSize=MM_MAX_DUMP_INEVENT_BYTES Pattern=x'FFFFFFFF' SymName="" Offset=validAddr
/SCX_CPU1_MM_Fill MEM16 DataSize=14 Pattern=x'FFFFFFFF' SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_FILL) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM16) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_DataValue = x'FFFF') AND ;;
     (SCX_CPU1_MM_BytesProc = 14) AND ;;
     (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM16 DataSize=MM_MAX_FILL_DATA_MEM16+1 Pattern=x'AAAAAAAA' SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM16 DataSize=MM_MAX_FILL_DATA_MEM16 Pattern=x'55555555' SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_FILL) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM16) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_DataValue = x'5555') AND ;;
     (SCX_CPU1_MM_BytesProc = MM_MAX_FILL_DATA_MEM16) AND ;;
     (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm16_513_dump.dat",hostCPU,appPktID,"MEM16",MM_MAX_FILL_DATA_MEM16,"",validAddr)
...
;; Delete the onboard file
s ftp_file (ramDir,"na","mm16_513_dump.dat",hostCPU,"R")
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM16 DataSize=2 Pattern=x'BBBBBBBB' SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent MEM16 DataSize=6 SymName="" Offset=validAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM16 DataSize=10 Pattern=x'FFFFFFFF' SymName="" Offset=invalidAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
;; Prior to 2.4.1.0, MM_MAX_DUMP_INEVENT_BYTES was MEM32 aligned
;;/SCX_CPU1_MM_Fill MEM32 DataSize=MM_MAX_DUMP_INEVENT_BYTES Pattern=x'FFFFFFFF' SymName="" Offset=validAddr
/SCX_CPU1_MM_Fill MEM32 DataSize=12 Pattern=x'FFFFFFFF' SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_FILL) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM32) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_DataValue = x'FFFFFFFF') AND ;;
     (SCX_CPU1_MM_BytesProc = 12) AND ;;
     (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
...
;; Send the command
;; Prior to 2.4.1.0, MM_MAX_DUMP_INEVENT_BYTES was MEM32 aligned
;;/SCX_CPU1_MM_DumpInEvent MEM32 DataSize=MM_MAX_DUMP_INEVENT_BYTES SymName="" Offset=validAddr
/SCX_CPU1_MM_DumpInEvent MEM32 DataSize=12 SymName="" Offset=validAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM32 DataSize=MM_MAX_FILL_DATA_MEM32+1 Pattern=x'AAAAAAAA' SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM32 DataSize=MM_MAX_FILL_DATA_MEM32 Pattern=x'55555555' SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_FILL) AND ;;
     (SCX_CPU1_MM_MemType = MM_MEM32) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_DataValue = x'55555555') AND ;;
     (SCX_CPU1_MM_BytesProc = MM_MAX_FILL_DATA_MEM32) AND ;;
     (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Dump command and transfer the file to ground
s get_mm_file_to_cvt(ramDir,"mm32_521dump.dat",hostCPU,appPktID,"MEM32",MM_MAX_FILL_DATA_MEM32,"",validAddr)
...
;; Delete the onboard file
s ftp_file (ramDir,"na","mm32_521dump.dat",hostCPU,"R")
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM32 DataSize=4 Pattern=x'BBBBBBBB' SymName="" Offset=validAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM32 DataSize=10 Pattern=x'FFFFFFFF' SymName="" Offset=invalidAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill MEM8 DataSize=0 Pattern=x'FAFAFAFA' SymName="" Offset=validAddr
...
clear SCX_CPU1_MM_HK
clear SCX_CPU1_TST_MM_HK
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_mm_memmap                                  "
write ";*********************************************************************"
ENDPROC
