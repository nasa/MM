...
ut_setupevents "SCX","CPU1",{MMAppName},MM_SYMTBL_TO_FILE_INF_EID,"INFO",1
ut_setupevents "SCX","CPU1",{MMAppName},MM_SYMTBL_TO_FILE_FAIL_ERR_EID,"ERROR",2

cmdCtr = SCX_CPU1_MM_CMDPC + 1

;; Send the command
/SCX_CPU1_MM_SymTbl2File FileName="/ram/symbolFile.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_SYMTBL_TO_FILE_INF_EID,"."
  ut_setrequirements MM_1009, "F"
endif

if (SCX_CPU1_find_event[2].num_found_messages = 1) then
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=8 RAM SymName="validRAM" Offset=1
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent RAM DataSize=3 SymName="validRAM" Offset=0
...
/SCX_CPU1_MM_Poke DataSize=8 RAM Data=pokeValue SymName="validRAM" Offset=1
...
/SCX_CPU1_MM_LoadWID DataSize=dataToSend CRC=validCRC SymName="validRAM" Offset=0 Data=widDataArray
...
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=0 Pattern=x'AF' RAM SymbolName="validRAM" Filename="/ram/validramload.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill RAM DataSize=MM_MAX_DUMP_INEVENT_BYTES Pattern=x'FFAAEEBB' SymName="validRAM" Offset=0
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=8 EEPROM SymName="validEEPROM" Offset=1
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent EEPROM DataSize=3 SymName="validEEPROM" Offset=0
...
/SCX_CPU1_MM_Poke DataSize=8 EEPROM Data=pokeValue SymName="validEEPROM" Offset=1
...
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=0 Pattern=x'AF' EEPROM SymbolName="validEEPROM" Filename="/ram/valideeload.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill EEPROM DataSize=MM_MAX_DUMP_INEVENT_BYTES Pattern=x'FFAAEEBB' SymName="validEEPROM" Offset=0
...
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_SYM_LOOKUP_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1

/SCX_CPU1_MM_LookupSymbol SymName="validRAM"
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_SYM_LOOKUP) AND ;;
     (SCX_CPU1_MM_MemType = 0) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND (SCX_CPU1_MM_DataValue = 0) AND ;;
     (SCX_CPU1_MM_BytesProc = 0) AND ;;
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_SYM_LOOKUP_INF_EID,"."
  ut_setrequirements MM_1009, "F"
endif
...
write ";**********************************************************************"
;; Setup for the event
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_SYMNAME_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1 

/SCX_CPU1_MM_Poke DataSize=32 RAM Data=pokeValue SymName="InvalidSymbolName" Offset=0
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (7004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_SYMNAME_ERR_EID,"."
  ut_setrequirements MM_7004, "F"
endif
...
/SCX_CPU1_MM_Peek DataSize=8 RAM SymName="invalidRAMSymbol" Offset=0
...
/SCX_CPU1_MM_LoadWID DataSize=128 CRC=validCRC SymName="invalidRAMSymbol" Offset=0 Data=widDataArray
...
/SCX_CPU1_MM_DumpInEvent RAM DataSize=3 SymName="invalidRAMSymbol" Offset=0
...
;; Send the TST_MM command to create the file - will need to add Symbolname
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=0 Pattern=x'AF' RAM SymbolName="invalidRAMSymbol" Filename="/ram/invalidramsymb.dat"
wait 5
...
errCtr = SCX_CPU1_MM_CMDEC + 1 
/SCX_CPU1_MM_LoadFile Filename="/ram/invalidramsymb.dat"
...
/SCX_CPU1_MM_Fill RAM DataSize=MM_MAX_DUMP_INEVENT_BYTES Pattern=x'FFAAEEBB' SymName="invalidRAMSymbol" Offset=0
...
/SCX_CPU1_MM_Poke DataSize=32 EEPROM Data=pokeValue SymName="InvalidEEPROMSymbol" Offset=0
...
/SCX_CPU1_MM_Peek DataSize=8 EEPROM SymName="invalidEEPROMSymbol" Offset=0
...
/SCX_CPU1_MM_DumpInEvent EEPROM DataSize=3 SymName="invalidEEPROMSymbol" Offset=0
...
;; Send the TST_MM command to create the file - will need to add Symbolname
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=0 Pattern=x'AF' EEPROM SymbolName="invalidEEPROMSymbol" Filename="/ram/invalideesymb.dat"
wait 5
...
errCtr = SCX_CPU1_MM_CMDEC + 1 
/SCX_CPU1_MM_LoadFile Filename="/ram/invalideesymb.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1 
/SCX_CPU1_MM_Fill EEPROM DataSize=MM_MAX_DUMP_INEVENT_BYTES Pattern=x'FFAAEEBB' SymName="invalidEEPROMSymbol" Offset=0
...
/SCX_CPU1_MM_LookupSymbol SymName="invalidSymbolName"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_SYMNAME_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
write ";**********************************************************************"
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_SYMNAME_NUL_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1

/SCX_CPU1_MM_LookupSymbol SymName=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_SYMNAME_NUL_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
write ";**********************************************************************"
ut_setupevents "SCX","CPU1",{MMAppName},MM_SYMFILENAME_NUL_ERR_EID,"ERROR",1

errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_SymTbl2File FileName=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_SYMFILENAME_NUL_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
write ";**********************************************************************"
ut_setupevents "SCX","CPU1",{MMAppName},MM_SYMTBL_TO_FILE_FAIL_ERR_EID,"ERROR",1

errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_SymTbl2File FileName="/boot/symfile.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_SYMTBL_TO_FILE_FAIL_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
write ";**********************************************************************"
ut_setupevents "SCX","CPU1",{MMAppName},MM_SYMTBL_TO_FILE_INVALID_ERR_EID,"ERROR",1

errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_SymTbl2File FileName="/boot/sym(file).dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_SYMTBL_TO_FILE_INVALID_ERR_EID,"."
  ut_setrequirements MM_1010, "F"
endif
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_mm_symtab                                   "
write ";*********************************************************************"
ENDPROC
