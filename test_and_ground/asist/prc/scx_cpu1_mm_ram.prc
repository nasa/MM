...
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=8 RAM SymName="" Offset=validAddr
...
;;	Will have to parse the event msg that gets returned
  ...
  if (SCX_CPU1_MM_LastActn = MM_PEEK) AND ;;
     (SCX_CPU1_MM_MemType = MM_RAM) AND ;;
  ...
  write "<!> Failed (1009;2002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_PEEK_BYTE_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_2002, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent RAM DataSize=3 SymName="" Offset=validAddr-1
...
/SCX_CPU1_MM_Poke DataSize=8 RAM Data=pokeValue SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;2000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_POKE_BYTE_INF_EID,"."
  ut_setrequirements MM_1009, "F"
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=16 RAM SymName="" Offset=validAddr
...
;;	Will have to parse the event msg that gets returned
  ...
  write "<!> Failed (1009;2002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_PEEK_WORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_2002, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent RAM DataSize=6 SymName="" Offset=validAddr-2
...
/SCX_CPU1_MM_Poke DataSize=16 RAM Data=pokeValue SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;2000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_POKE_WORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_20001, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Peek
/SCX_CPU1_MM_Peek DataSize=32 RAM SymName="" Offset=validAddr
...
;;	Will have to parse the event msg that gets returned
  ...
  write "<!> Failed (1009;2002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_PEEK_DWORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_2002, "F"
endif
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent RAM DataSize=12 SymName="" Offset=validAddr-4
...
/SCX_CPU1_MM_Poke DataSize=32 RAM Data=pokeValue SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009;2000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_POKE_DWORD_INF_EID,"."
  ut_setrequirements MM_1009, "F"
  ut_setrequirements MM_20001, "F"
endif
...
invalidAddr = SCX_CPU1_TST_MM_EEPROMAddress+4

/SCX_CPU1_MM_Poke DataSize=32 RAM Data=pokeValue SymName="" Offset=invalidAddr
...
/SCX_CPU1_MM_Poke DataSize=4 RAM Data=pokeValue SymName="" Offset=validAddr
...
/SCX_CPU1_MM_Peek DataSize=32 RAM SymName="" Offset=invalidAddr
...
/SCX_CPU1_MM_Peek DataSize=3 RAM SymName="" Offset=validAddr
...
ut_setupevents "SCX", "CPU1", "TST_MM", TST_MM_GETCRC_INF_EID, "INFO", 1

;; Calculate CRC on Data by sending a TST_MM command
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_GetCRC DataSize=dataToSend dataArray=testDataArray
...
validCRC = SCX_CPU1_TST_MM_ValidCRC

;; Setup for the Load_WID Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_LOAD_WID_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the Load with interrupts disabled command
/SCX_CPU1_MM_LoadWID DataSize=dataToSend CRC=validCRC SymName="" Offset=validAddr Data=widDataArray
...
if (UT_TW_Status = UT_Success) then
  ...
  ut_setrequirements MM_1009, "P"
  ;; Verify the Last Command HK items
  if (SCX_CPU1_MM_LastActn = MM_LOAD_WID) AND ;;
     (SCX_CPU1_MM_MemType = MM_RAM) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = dataToSend) AND (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_LOAD_WID_INF_EID,"."
  ut_setrequirements MM_1009, "F"
endif
...
write ";**********************************************************************"
;; Setup for the Load_WID Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_LOAD_WID_CRC_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the Load with interrupts disabled command
/SCX_CPU1_MM_LoadWID DataSize=dataToSend CRC=0 SymName="" Offset=validAddr Data=widDataArray
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",MM_LOAD_WID_CRC_ERR_EID,"."
  ut_setrequirements MM_1009, "F"
endif
...
/SCX_CPU1_MM_LoadWID DataSize=dataToSend CRC=validCRC SymName="" Offset=invalidAddr Data=widDataArray
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent RAM DataSize=eventBytes SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent RAM DataSize=MM_MAX_DUMP_INEVENT_BYTES SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_DumpInEvent RAM DataSize=1 SymName="" Offset=validAddr
...
/SCX_CPU1_MM_DumpInEvent RAM DataSize=10 SymName="" Offset=invalidAddr
...
/SCX_CPU1_MM_DumpInEvent RAM DataSize=0 SymName="" Offset=validAddr
...
/SCX_CPU1_MM_LoadWID DataSize=0 CRC=validCRC SymName="" Offset=validAddr Data=widDataArray
...
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=validAddr Pattern=x'AF' RAM SymbolName="" Filename="/ram/validramload.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/validramload.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_LOAD_FROM_FILE) AND ;;
     ...
     (SCX_CPU1_MM_LastFile = "/ram/validramload.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_DUMP_TO_FILE) AND ;;
     ...
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = dataToSend) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/mm_ram4_2_dump.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateErrorFiles Address=validAddr Pattern=x'FA' RAM
wait 5
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=MM_MAX_LOAD_FILE_DATA_RAM Address=validAddr Pattern=x'AF' RAM SymbolName="" Filename="/ram/maxdataramload.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/maxdataramload.dat"
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_LOAD_FROM_FILE) AND ;;
     (SCX_CPU1_MM_MemType = MM_RAM) AND ;;
     (SCX_CPU1_MM_Address = validAddr) AND ;;
     (SCX_CPU1_MM_BytesProc = MM_MAX_LOAD_FILE_DATA_RAM) AND ;;
     (SCX_CPU1_MM_LastFile = "/ram/maxdataramload.dat") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
    write "<!> Failed (8000) - Last Command HK NOT correct."
...
;; Send the TST_MM command to create the file
cmdCtr = SCX_CPU1_TST_MM_CMDPC + 1
/SCX_CPU1_TST_MM_CreateFile DataSize=1 Address=validAddr Pattern=x'55' RAM SymbolName="" Filename="/ram/onebyteramload.dat"
wait 5
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/onebyteramload.dat"
...
/SCX_CPU1_TST_MM_CreateFile DataSize=dataToSend Address=invalidAddr Pattern=x'AF' RAM SymbolName="" Filename="/ram/badramaddrload.dat"

;; Setup for the Event message
ut_setupevents "SCX", "CPU1", {MMAppName}, MM_OS_MEMVALIDATE_ERR_EID, "ERROR", 1

errCtr = SCX_CPU1_MM_CMDEC + 1
/SCX_CPU1_MM_LoadFile Filename="/ram/badramaddrload.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File RAM DataSize=MM_MAX_DUMP_FILE_DATA_RAM+1 SymName="" Offset=validAddr Filename="/ram/mm_ram4_13_dump.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File RAM DataSize=dataToSend SymName="" Offset=invalidAddr Filename="/ram/mm_ram4_17_dump.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File RAM DataSize=dataToSend SymName="" Offset=validAddr Filename="mm_invalid_dumpname.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File RAM DataSize=0 SymName="" Offset=validAddr Filename="/ram/mm_dump_14_19_2.dat"
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Dump2File RAM DataSize=100 SymName="" Offset=validAddr Filename=""
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill RAM DataSize=MM_MAX_DUMP_INEVENT_BYTES Pattern=x'FFFFFFFF' SymName="" Offset=validAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill RAM DataSize=MM_MAX_FILL_DATA_RAM+1 Pattern=x'AAAAAAAA' SymName="" Offset=validAddr
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill RAM DataSize=MM_MAX_FILL_DATA_RAM Pattern=x'55555555' SymName="" Offset=validAddr
...
if (UT_TW_Status = UT_Success) then
  ...
  if (SCX_CPU1_MM_LastActn = MM_FILL) AND ;;
     ...
     (SCX_CPU1_MM_BytesProc = MM_MAX_FILL_DATA_RAM) AND ;;
     (SCX_CPU1_MM_LastFile = "") THEN
    write "<*> Passed (8000) - Last Command HK items as expected."
    ut_setrequirements MM_8000, "P"
  else
...
cmdCtr = SCX_CPU1_MM_CMDPC + 1
;; Send the command
/SCX_CPU1_MM_Fill RAM DataSize=1 Pattern=x'BBBBBBBB' SymName="" Offset=validAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill RAM DataSize=10 Pattern=x'FFFFFFFF' SymName="" Offset=invalidAddr
...
errCtr = SCX_CPU1_MM_CMDEC + 1
;; Send the command
/SCX_CPU1_MM_Fill RAM DataSize=0 Pattern=x'FAFAFAFA' SymName="" Offset=validAddr
...
/SCX_CPU1_ES_StopPerf DataFileName="/ram/mm_ram_perf.dat"
wait 30
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_mm_ram                                      "
write ";*********************************************************************"
ENDPROC
