...
/** \brief <tt> 'OS_OpenCreate error received: RC = 0x\%08X File = '\%s'' </tt>
**  \event <tt> 'OS_OpenCreate error received: RC = 0x\%08X File = '\%s'' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
**  from the #OS_OpenCreate call that generated the error.
*/
...
**
**  The \c RC field is the function return code.
*/
...
/** \brief <tt> 'Error Subscribing to MM Command, RC = 0x\%08X' </tt>
**  \event <tt> 'Error Subscribing to MM Command, RC = 0x\%08X' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'MM_FillMem32 NumOfBytes not multiple of 4. Reducing from %d to %d.' </tt>
**  \event <tt> 'MM_FillMem32 NumOfBytes not multiple of 4. Reducing from %d to %d.' </tt>
**
...
**
**  The \c from field is the original NumOfBytes parameter.
**  The \c to field is the rounded down NumOfBytes value
*/
#define MM_FILL_MEM32_ALIGN_WARN_INF_EID 63

/** \brief <tt> 'MM_FillMem16 NumOfBytes not multiple of 2. Reducing from %d to %d.' </tt>
**  \event <tt> 'MM_FillMem16 NumOfBytes not multiple of 2. Reducing from %d to %d.' </tt>
**
**  \par Type: INFORMATION
**
**  \par Cause:
